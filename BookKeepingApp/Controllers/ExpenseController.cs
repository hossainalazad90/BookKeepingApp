...
namespace BookKeepingApp.Controllers
{
    public class ExpenseController : Controller
    {
        ...
        public ExpenseController(IIncomeExpenseService incomeExpenseService, IIncomeExpenseHeadService incomeExpenseHeadService)
        {
        ...
        {
            var result = _incomeExpenseService.GetAll(HeadEnum.Expense);
            return View(result);
        }
        ...
        {
            ViewBag.IncomeExpenseHeadId = new SelectList(_incomeExpenseHeadService.GetAll(HeadEnum.Expense), "Id", "HeadName");
            return View();
        }
        ...
        {
            ViewBag.IncomeExpenseHeadId = new SelectList(_incomeExpenseHeadService.GetAll(HeadEnum.Expense), "Id", "HeadName", model.IncomeExpenseHeadId);
            try
            {
        ...
        public ActionResult Edit(int id)
        {
            ...
            var result = _incomeExpenseService.Get(id);
            ViewBag.IncomeExpenseHeadId = new SelectList(_incomeExpenseHeadService.GetAll(HeadEnum.Expense), "Id", "HeadName", result.IncomeExpenseHeadId);
            return View(result);
        }
